...
$staffid = $_SESSION['staffid']; // Get the logged-in volunteer ID
...
<th><strong>Edit</strong></th>
      ...
      <tbody>
        ...
        if (isset($_SESSION['staffid'])) {
            ...
            $sql = "SELECT  staffid,name,idno,address,phoneno,position,username,password FROM staff WHERE username = '".$_SESSION['staffid']."';";
        ...
        <td class="action-btn">
                    <a href="manageprofile.php?id=<?php echo htmlspecialchars($row["staffid"]); ?>" class="edit">Edit</a>
                </td>
        </tr>
        <?php }
        } else {
