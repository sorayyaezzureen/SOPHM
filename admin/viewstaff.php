    ...
    <table border="0">
      <thead>
        <tr>
          ...
          <th><strong>No. Kad Pengenalan</strong></th>
          <th><strong>Alamat Rumah</strong></th>
      ...
      <tbody>
        ...
        $sql = "SELECT staffid, name, idno, address, phoneno, position FROM staff ORDER BY staffid DESC";
        ...
        ?>
        <tr>
          <td align="center"><?php echo htmlspecialchars($row['staffid']); ?></td>
          <td align="center"><?php echo htmlspecialchars($row['name']); ?></td>
          <td align="center"><?php echo htmlspecialchars($row['idno']); ?></td>
          <td align="center"><?php echo htmlspecialchars($row['address']); ?></td>
          <td align="center"><?php echo htmlspecialchars($row['phoneno']); ?></td>
          <td align="center"><?php echo htmlspecialchars($row['position']); ?></td>
          <td class="action-btn">
              <a href="managestaff.php?id=<?php echo htmlspecialchars($row['staffid']); ?>" class="edit">Edit</a>
          </td>
        </tr>
        <?php 
            }
