...
<div class="container" style="padding:85px 80px">
    <h2 class="text-center">Rekod Penderma</h2>
    <table border="0">
      <thead>
        <tr>
      ...
      <tbody>
        ...
        $sql = "SELECT donorid,name,email,phoneno,username from donor ORDER BY donorid DESC";
        ...
        if ($stmt = $con->prepare($sql)) {
            ...
            while ($row = $result->fetch_assoc()) { ?>
              <tr>
                ...
                <td class="action-btn">
                    <a href="managedonor.php?id=<?php echo htmlspecialchars($row["donorid"]); ?>" class="edit">Edit</a>
                </td>
              </tr>
