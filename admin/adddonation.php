...
if (isset($_POST["submit"])) {
    ...
    $otherquantity = $_POST["otherquantity"];
    ...
    $required_fields = ['place' => $place, 'quantity' => $quantity, 'amountrm' => $amountrm, 'category' => $category, 'donorid' => $donorid];
    ...
    <form action="adddonation.php" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
       <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="donorid" name="donorid" required>
                <option value="">Pilih Penderma</option>
                <?php foreach ($donors as $donor): ?>
                    <option value="<?php echo htmlspecialchars($donor); ?>"><?php echo htmlspecialchars($donor); ?></option>
                <?php endforeach; ?>
            </select>
        </div>
