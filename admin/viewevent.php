...
<head>
    ...
    <title>Rekod Aktiviti | Admin</title>
...
<div class="container" style="padding:85px 80px">
    <h2 class="text-center">Rekod Aktiviti</h2>
    <table border="0">
      <thead>
        <tr>
<th><strong>Nama</strong></th>
<th><strong>Objektif</strong></th>
<th><strong>Tempat</strong></th>
<th><strong>Jumlah Kos</strong></th>
<th><strong>Tarikh dan Masa</strong></th>
<!-- <th><strong>Dokumen Aktiviti</strong></th> -->
<th><strong>Edit</strong></th>
      ...
      <tbody>
        ...
        <?php
$count=1;
$sel_query="SELECT eventid,name,description,venue,estimatedcost,datetime,eventproposal from events ORDER BY eventid desc;";
...
<!-- <td align="center"><--?php echo $row['eventid']?></td> -->
                               ...
                               <td align="center"><?php echo $row['estimatedcost']?></td>
                               <td align="center"><?php echo $row['datetime']?></td>
                               <td class="action-btn">
              <a href="manageevent.php?id=<?php echo htmlspecialchars($row['eventid']); ?>" class="edit">Edit</a>
          </td>
</tr>
<?php $count++; } ?>
      </tbody>
