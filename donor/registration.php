...
if (isset($_POST["submit"])) {
    ...
    if (count($errors) > 0) {
        ...
        $sql = "INSERT INTO donor (name, email, phoneno, username, password) VALUES (?, ?, ?, ?, ?)";
        $stmt = mysqli_prepare($con, $sql);
        if ($stmt) {
...
<head>
    ...
    <style>
        ...
        #deathcertnumber, #otherrelationship {
            display: none;
        }
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="/SOPHM/home.php">Laman Utama</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/SOPHM/donor/login.php">Log Masuk</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container form-container">
    <h2 class="text-center">Daftar Akaun Penderma</h2>
    <form action="registration.php" method="post" class="needs-validation" novalidate>
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" name="name" placeholder="Nama" title="Sila isi nama" pattern="[a-zA-Z][a-zA-Z0-9\s]*" required>
        </div>
        <div class="form-group">
